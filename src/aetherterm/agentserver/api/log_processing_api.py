...
async def add_terminal(request: TerminalRequest):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to add terminal: {str(e)}")
...
async def get_terminal_statistics(terminal_id: str):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get terminal statistics: {str(e)}")
...
async def simulate_output(request: SimulateOutputRequest):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to simulate output: {str(e)}")
...
async def test_error_patterns():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error pattern test failed: {str(e)}")
...
async def test_command_patterns():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Command pattern test failed: {str(e)}")
...
async def stress_test_storage(request: StressTestRequest):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Storage stress test failed: {str(e)}")
